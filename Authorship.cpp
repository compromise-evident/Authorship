...
/* Version 4, 12,000-digit multi-way functions. This is computational difficulty
...
Once you become a government threat, the public inquires about your well being--
 ...
 * New: voter fraud prevention, animal theft management.
--------------------------------------------------------------------------------
...
{	int user_option;
	...
	{	ifstream in_stream;
		...
		//# 77      1 0 1 0 1 0 1 0 1       76          l   (l as in laminar)  (108)
		...
		//Selectively writes old[] to file Authorship.public SELECTIVENESS IS BASED ON THE CONTENTS OF b[]. (Authorship.public is a new file created now.)
		...
		cout << "\n\n\n\n\n\n\n\n\n\n\nFinished.\n\n\n"
		     ...
		     << "need YOUR Authorship.number file, it will be intertwined within\n"
	...
	{	ifstream in_stream;
		...
		//Checks if file Authorship.number is present.
