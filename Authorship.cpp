...
{	int user_option; //These three functionalities reuse code and run independently (highly modular & audit-friendly.)
	...
	//OPTION 2 ====> line 1010.       OPTION 3 ====> line 2470.
	cout << "\n(Authorship) - infinite authentication tool\n\n"
	...
	{	//BASIC LAYOUT:
		...
		for(int a = 0; a < 500; a++) //Loads binary expansion for number into b[]. (The first 500 groups of nine in b[] will represent the Authorship number, each group giving a digit pair.)
		{
			...
			else {cout << "\n\nCosmic ray corruption, line 2207.\n\n"; return 0;}
		}
		...
		{	m = 4500; //Again, sets write head of b[] to where the user message will begin in "5/9 binary." b[4500] is the 4,501st element.
			...
			{	
				...
				else {cout << "\n\nCosmic ray corruption, line 2334.\n\n"; return 0;}
			}
		}
		...
		{	if(b[revelation] == 0)
			{	/// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				{	if(hash_digits_table[a] == 0) {old_read_bookmark++;}
					...
					{	     if(old[old_read_bookmark] == 48) {out_stream << '0';}
						else if(old[old_read_bookmark] == 49) {out_stream << '1';}
						else if(old[old_read_bookmark] == 50) {out_stream << '2';}
						else if(old[old_read_bookmark] == 51) {out_stream << '3';}
						else if(old[old_read_bookmark] == 52) {out_stream << '4';}
						else if(old[old_read_bookmark] == 53) {out_stream << '5';}
						else if(old[old_read_bookmark] == 54) {out_stream << '6';}
						else if(old[old_read_bookmark] == 55) {out_stream << '7';}
						else if(old[old_read_bookmark] == 56) {out_stream << '8';}
						else if(old[old_read_bookmark] == 57) {out_stream << '9';}
						else           {cout << "\n\nCosmic ray corruption, line 2370.\n\n"; return 0;}
			...
			{	/// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				{	     if(old[old_read_bookmark] == 48) {out_stream << '0';}
					...
					else if(old[old_read_bookmark] == 46) {out_stream << '.';}
					else {cout << "\n\nCosmic ray corruption, line 2393.\n\n"; return 0;}
			...
			{	for(int a = 0; a < 5; a++)
				{	while(old[old_read_bookmark] != '.')
					{	     if(old[old_read_bookmark] == 48) {out_stream << '0';}
						...
						else {cout << "\n\nCosmic ray corruption, line 2413.\n\n"; return 0;}
	...
	{	//Basic layout:
		...
		{	     if(Authorship_public[a] == 48) {Authorship_public[a] = 0;}
			...
			else {cout << "\n\nCosmic ray corruption, line 2522.\n\n"; return 0;}
		}
		...
		{	in_stream >> Authorship_number[a];
			...
			else {cout << "\n\nCosmic ray file corruption, line 2823.\n\n"; return 0;}
		}
		...
		for(int a = 0; a < 1000; a++)
		{	if(compression[a] != Authorship_number[a]) {cout << "\n\n\nVerification FAILED! Numbers mismatch! 2831\n\n\n"; return 0;}
